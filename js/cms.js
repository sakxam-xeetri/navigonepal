...
const NAVIGO_CMS = {
  ...
  story: {
    ...
    foundingStory: "<p><strong>Navigo Nepal</strong> was founded in early 2024 by <strong>Anupam Neupane</strong>, <strong>Biyog Man Dangol</strong>, and <strong>Prajwal Dhungana</strong> with a simple but meaningful goal: to help students confidently navigate life after SEE (Grade 10). Having experienced the uncertainty that many students face when choosing streams and planning their futures, they saw the need for guidance that schools often couldn't provide. This inspired them to create <strong>Navigo</strong>—derived from the Latin word meaning \"to navigate\"—to bridge the gap between school education and real-world opportunities.</p><p>What began as a series of small, community-focused workshops in Nuwakot has since grown into a nationwide, youth-led initiative. Today, <strong>Navigo Nepal</strong> works alongside its strategic partner, <strong>Gurubaa</strong>—Nepal's largest educational content creator—and is powered by a passionate network of student leaders, district ambassadors known as <em>Navigers</em>, and dedicated volunteers. Together, they are helping thousands of students make informed academic and career decisions with confidence.</p>",
    leadershipMessage: {
