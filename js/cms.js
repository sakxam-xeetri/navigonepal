...
const NAVIGO_CMS = {
  ...
  story: {
    ...
    foundingStory: "<p><strong>Navigo Nepal</strong> was founded in early 2024 by <strong>Anupam Neupane</strong>, <strong>Biyog Man Dangol</strong>, and <strong>Prajwal Dhungana</strong>. Realizing that the school system left SEE (grade 10) graduates unprepared and anxious about stream and career transitions, they established <strong>Navigo</strong>—Latin for <em>'Navigate'</em>—to build a practical learning bridge.</p><p>Starting with grass-roots workshops in Nuwakot, <strong>Navigo Nepal</strong> has rapidly expanded into a youth-led movement. The co-founders are supported by a strategic partnership with <strong>Gurubaa</strong>, Nepal's largest educational content creator, and a growing cohort of local student leaders, district ambassadors (<em>'Navigers'</em>), and volunteers.</p>",
    leadershipMessage: {
